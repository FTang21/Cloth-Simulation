...
import { MassSpringAnimation } from "./App.js";
...
export class GUI implements IGUI {
  ...
  private static readonly walkSpeed: number = 0.1;
  ...
  private animation: MassSpringAnimation;
   ...
   */
  constructor(canvas: HTMLCanvasElement, animation: MassSpringAnimation) {
  ...
  public walkDir(): Vec3
  {
      ...
      answer.normalize().scale(GUI.walkSpeed);
      return answer;
  }
